...
void main() {
  runApp(const ChatPageViewProvider());
}
...
class ChatPageViewProvider extends StatefulWidget {
  const ChatPageViewProvider({super.key});
  @override
  State<ChatPageViewProvider> createState() => _ChatPageViewState();
}
...
class _ChatPageViewState extends State<ChatPageViewProvider>{
  ...
  void _SendAction( MessageProvider provider) async {
    ...
    if(file != null){
      ...
      setState(() => provider.messages.add(message),);
